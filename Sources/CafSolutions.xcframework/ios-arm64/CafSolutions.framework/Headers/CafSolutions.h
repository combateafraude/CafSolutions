...
@class CafSolutionsCafHttpResponse, CafSolutionsCafAttestationInformationParamCompanion, CafSolutionsCafAttestationInformationParam, CafSolutionsCafAttestationSettingsParamCompanion, CafSolutionsCafAttestationSettingsParam, CafSolutionsKotlinEnumCompanion, CafSolutionsKotlinEnum<E>, CafSolutionsCafEvent, CafSolutionsKotlinArray<T>, CafSolutionsCafEventType, CafSolutionsCafFeatureToggleEvent, CafSolutionsCafPlatform, CafSolutionsKotlinx_serialization_jsonJsonElement, CafSolutionsCafAPIResponsePropertiesCompanion, CafSolutionsCafAPIResponseProperties, CafSolutionsCafAppIdentifiedPropertiesCompanion, CafSolutionsCafAppIdentifiedProperties, CafSolutionsCafDefaultPropertiesCompanion, CafSolutionsCafDefaultProperties, CafSolutionsCafDeviceDataPropertiesCompanion, CafSolutionsCafDeviceDataProperties, CafSolutionsCafDeviceIdentifiedPropertiesCompanion, CafSolutionsCafDeviceIdentifiedProperties, CafSolutionsCafErrorPropertiesCompanion, CafSolutionsCafErrorProperties, CafSolutionsCafFingerPrintPropertiesCompanion, CafSolutionsCafFingerPrintProperties, CafSolutionsCafMemoryInfoPropertiesCompanion, CafSolutionsCafMemoryInfoProperties, CafSolutionsCafPermissionPropertiesCompanion, CafSolutionsCafPermissionProperties, CafSolutionsCafPropertiesBaseCompanion, CafSolutionsCafProviderPropertiesCompanion, CafSolutionsCafProviderProperties, CafSolutionsCafSDKConfigurationPropertiesCompanion, CafSolutionsCafSDKConfigurationProperties, CafSolutionsCafSDKResultPropertiesCompanion, CafSolutionsCafSDKResultProperties, CafSolutionsCafServices, CafSolutionsCafTrackerCompanion, CafSolutionsCafUploadDecodedCompanion, CafSolutionsCafUploadDecoded, CafSolutionsKotlinx_serialization_jsonJsonElementCompanion, CafSolutionsKotlinThrowable, CafSolutionsKotlinException, CafSolutionsKotlinRuntimeException, CafSolutionsKotlinIllegalStateException, CafSolutionsKotlinx_serialization_coreSerializersModule, CafSolutionsKotlinx_serialization_coreSerialKind, CafSolutionsKotlinNothing;

@protocol CafSolutionsKotlinx_serialization_coreKSerializer, CafSolutionsKotlinComparable, CafSolutionsCafPropertiesBase, CafSolutionsCafDocumentDetectorService, CafSolutionsKotlinx_serialization_coreEncoder, CafSolutionsKotlinx_serialization_coreSerialDescriptor, CafSolutionsKotlinx_serialization_coreSerializationStrategy, CafSolutionsKotlinx_serialization_coreDecoder, CafSolutionsKotlinx_serialization_coreDeserializationStrategy, CafSolutionsKotlinIterator, CafSolutionsKotlinx_serialization_coreCompositeEncoder, CafSolutionsKotlinAnnotation, CafSolutionsKotlinx_serialization_coreCompositeDecoder, CafSolutionsKotlinx_serialization_coreSerializersModuleCollector, CafSolutionsKotlinKClass, CafSolutionsKotlinKDeclarationContainer, CafSolutionsKotlinKAnnotatedElement, CafSolutionsKotlinKClassifier;
...
- (instancetype)initWithIsSuccess:(BOOL)isSuccess statusCode:(int32_t)statusCode headers:(NSDictionary<NSString *, NSString *> *)headers body:(NSString * _Nullable)body __attribute__((swift_name("init(isSuccess:statusCode:headers:body:)"))) __attribute__((objc_designated_initializer));
- (CafSolutionsCafHttpResponse *)doCopyIsSuccess:(BOOL)isSuccess statusCode:(int32_t)statusCode headers:(NSDictionary<NSString *, NSString *> *)headers body:(NSString * _Nullable)body __attribute__((swift_name("doCopy(isSuccess:statusCode:headers:body:)")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafAttestationInformationParam")))
@interface CafSolutionsCafAttestationInformationParam : CafSolutionsBase
- (instancetype)initWithManufacturer:(NSString * _Nullable)manufacturer model:(NSString * _Nullable)model __attribute__((swift_name("init(manufacturer:model:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) CafSolutionsCafAttestationInformationParamCompanion *companion __attribute__((swift_name("companion")));
- (CafSolutionsCafAttestationInformationParam *)doCopyManufacturer:(NSString * _Nullable)manufacturer model:(NSString * _Nullable)model __attribute__((swift_name("doCopy(manufacturer:model:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafAttestationInformationParam.Companion")))
@interface CafSolutionsCafAttestationInformationParamCompanion : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafAttestationInformationParamCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafAttestationSettingsParam")))
@interface CafSolutionsCafAttestationSettingsParam : CafSolutionsBase
- (instancetype)initWithAppName:(NSString * _Nullable)appName appVersion:(NSString * _Nullable)appVersion batteryPercentage:(NSString * _Nullable)batteryPercentage __attribute__((swift_name("init(appName:appVersion:batteryPercentage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) CafSolutionsCafAttestationSettingsParamCompanion *companion __attribute__((swift_name("companion")));
- (CafSolutionsCafAttestationSettingsParam *)doCopyAppName:(NSString * _Nullable)appName appVersion:(NSString * _Nullable)appVersion batteryPercentage:(NSString * _Nullable)batteryPercentage __attribute__((swift_name("doCopy(appName:appVersion:batteryPercentage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@property (readonly) NSString * _Nullable batteryPercentage __attribute__((swift_name("batteryPercentage")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafAttestationSettingsParam.Companion")))
@interface CafSolutionsCafAttestationSettingsParamCompanion : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafAttestationSettingsParamCompanion *shared __attribute__((swift_name("shared")));
- (id<CafSolutionsKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@property (class, readonly) CafSolutionsCafEvent *fingerprintResponse __attribute__((swift_name("fingerprintResponse")));
@property (class, readonly) CafSolutionsCafEvent *providerResponse __attribute__((swift_name("providerResponse")));
...
@property (class, readonly) CafSolutionsCafEvent *livenessError __attribute__((swift_name("livenessError")));
@property (class, readonly) CafSolutionsCafEvent *tokenError __attribute__((swift_name("tokenError")));
@property (class, readonly) CafSolutionsCafEvent *unsupportedDeviceError __attribute__((swift_name("unsupportedDeviceError")));
...
- (CafSolutionsCafDefaultProperties *)doCopyRequestParams:(NSDictionary<NSString *, NSString *> * _Nullable)requestParams requestBody:(NSString * _Nullable)requestBody __attribute__((swift_name("doCopy(requestParams:requestBody:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable requestBody __attribute__((swift_name("requestBody")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafFingerPrintProperties")))
@interface CafSolutionsCafFingerPrintProperties : CafSolutionsBase <CafSolutionsCafPropertiesBase>
- (instancetype)initWithRequestId:(NSString *)requestId visitorId:(NSString *)visitorId __attribute__((swift_name("init(requestId:visitorId:)"))) __attribute__((objc_designated_initializer));
- (instancetype)initWithRequestId:(NSString *)requestId visitorId:(NSString *)visitorId requestParams:(NSDictionary<NSString *, NSString *> * _Nullable)requestParams requestBody:(NSString * _Nullable)requestBody __attribute__((swift_name("init(requestId:visitorId:requestParams:requestBody:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) CafSolutionsCafFingerPrintPropertiesCompanion *companion __attribute__((swift_name("companion")));
- (CafSolutionsCafFingerPrintProperties *)doCopyRequestId:(NSString *)requestId visitorId:(NSString *)visitorId requestParams:(NSDictionary<NSString *, NSString *> * _Nullable)requestParams requestBody:(NSString * _Nullable)requestBody __attribute__((swift_name("doCopy(requestId:visitorId:requestParams:requestBody:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable requestBody __attribute__((swift_name("requestBody")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafFingerPrintProperties.Companion")))
@interface CafSolutionsCafFingerPrintPropertiesCompanion : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafFingerPrintPropertiesCompanion *shared __attribute__((swift_name("shared")));
- (id<CafSolutionsKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafProviderProperties")))
@interface CafSolutionsCafProviderProperties : CafSolutionsBase <CafSolutionsCafPropertiesBase>
...
- (instancetype)initWithResponse:(NSString *)response requestParams:(NSDictionary<NSString *, NSString *> * _Nullable)requestParams requestBody:(NSString * _Nullable)requestBody __attribute__((swift_name("init(response:requestParams:requestBody:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) CafSolutionsCafProviderPropertiesCompanion *companion __attribute__((swift_name("companion")));
- (CafSolutionsCafProviderProperties *)doCopyResponse:(NSString *)response requestParams:(NSDictionary<NSString *, NSString *> * _Nullable)requestParams requestBody:(NSString * _Nullable)requestBody __attribute__((swift_name("doCopy(response:requestParams:requestBody:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable requestBody __attribute__((swift_name("requestBody")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafProviderProperties.Companion")))
@interface CafSolutionsCafProviderPropertiesCompanion : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafProviderPropertiesCompanion *shared __attribute__((swift_name("shared")));
- (id<CafSolutionsKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
__attribute__((swift_name("CafDocumentDetectorService")))
@protocol CafSolutionsCafDocumentDetectorService
@required
...
*/
- (void)sendRequestEndpoint:(NSString *)endpoint headers:(NSDictionary<NSString *, NSString *> *)headers body:(NSString *)body completionHandler:(void (^)(CafSolutionsCafHttpResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("sendRequest(endpoint:headers:body:completionHandler:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafServices")))
@interface CafSolutionsCafServices : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)cafServices __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafServices *shared __attribute__((swift_name("shared")));
- (id<CafSolutionsCafDocumentDetectorService>)getDocumentDetectorService __attribute__((swift_name("getDocumentDetectorService()")));
- (void)setStageStage:(NSString *)stage __attribute__((swift_name("setStage(stage:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafTracker")))
@interface CafSolutionsCafTracker : CafSolutionsBase
- (instancetype)initWithSessionId:(NSString *)sessionId platform:(CafSolutionsCafPlatform *)platform stage:(NSString *)stage clientId:(NSString *)clientId mobileToken:(NSString *)mobileToken personId:(NSString * _Nullable)personId sdkName:(NSString *)sdkName sdkVersion:(NSString *)sdkVersion __attribute__((swift_name("init(sessionId:platform:stage:clientId:mobileToken:personId:sdkName:sdkVersion:)"))) __attribute__((objc_designated_initializer));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafUploadDecoded")))
@interface CafSolutionsCafUploadDecoded : CafSolutionsBase
- (instancetype)initWithBucket:(NSString * _Nullable)bucket key:(NSString * _Nullable)key __attribute__((swift_name("init(bucket:key:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) CafSolutionsCafUploadDecodedCompanion *companion __attribute__((swift_name("companion")));
- (CafSolutionsCafUploadDecoded *)doCopyBucket:(NSString * _Nullable)bucket key:(NSString * _Nullable)key __attribute__((swift_name("doCopy(bucket:key:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CafUploadDecoded.Companion")))
@interface CafSolutionsCafUploadDecodedCompanion : CafSolutionsBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) CafSolutionsCafUploadDecodedCompanion *shared __attribute__((swift_name("shared")));
- (id<CafSolutionsKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
